...
class PendingUserLoginSpec extends AbstractSpecification {
    @Autowired
    private MockMvc mockMvc

    def "A user that is pending can not login"() {
        given: "I am a user that is pending"
        User user = users.aPendingUser()
