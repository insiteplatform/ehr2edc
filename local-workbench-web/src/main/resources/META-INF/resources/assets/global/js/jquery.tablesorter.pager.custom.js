/*!
 * CUSTOMIZED FOR CORRECT COOPERATION OF FILTER AND PAGER PLUGINS (CTRL-F 'CUSTOM ADDITIONS')
 * 
...
;(function($) {
	...
	$.extend({ tablesorterPager: new function() {
		...
		renderTable = function(table, rows, p) {
			...
			update_pager();
			// goto selector
			// This is normally done when constructing pager, but in our case, the page selection doesn't exist yet by construction
			$(p.cssGoto).off().on("click", function() {
				p.page = $(this).attr("page");
