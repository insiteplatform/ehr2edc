...
class LabValueResponseMapper implements ResponseMapper {
	...
	public GetSubmittedItemProvenance.Response map(ProvenanceDataPoint submittedProvenanceDataPoint) {
		ProvenanceLabValue labValue = (ProvenanceLabValue) submittedProvenanceDataPoint;
	...
	private void addConceptGroup(List<GetSubmittedItemProvenance.ProvenanceGroup> groups, ProvenanceLabValue labValue) {
	...
	private void addMeasurementGroup(List<GetSubmittedItemProvenance.ProvenanceGroup> groups,
			ProvenanceLabValue labValue) {
