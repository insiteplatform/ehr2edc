...
@Component
public class MedicationMongoQueryFactory {
	private static final String FIELD_CONCEPT = "concept.concept";
	private static final String FIELD_DATE = "startDate";

	private final MongoCriteriaFactory mongoCriteriaFactory;
	private final MongoSortFactory mongoSortFactory;

	MedicationMongoQueryFactory(MongoCriteriaFactory mongoCriteriaFactory, MongoSortFactory mongoSortFactory) {
