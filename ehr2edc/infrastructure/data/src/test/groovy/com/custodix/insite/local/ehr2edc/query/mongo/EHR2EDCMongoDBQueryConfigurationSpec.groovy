...
@ContextConfiguration(classes = [EHR2EDCMongoDBQueryConfiguration, EmbeddedMongoAutoConfiguration])
@TestPropertySource(locations = "classpath:ehr2edc-infra-mongo-query.properties")
class EHR2EDCMongoDBQueryConfigurationSpec extends Specification {
    ...
    @Document(value = EHR2EDCMongoDBQueryConfigurationSpec.TEST_DOCUMENT_COLLECTION)
