...
import com.custodix.insite.local.ehr2edc.ehr.epic.event.configuration.EHREpicEventConfiguration;
...
import com.custodix.insite.local.ehr2edc.event.controller.ExportPatientSearchCriteriaInformationController;
...
public class EHR2EDCEventConfiguration {
	...
	@Bean
	ExportPatientSearchCriteriaInformationController exportPatientIdsController(
			ExportPatientSearchCriteriaInformation exportPatientSearchCriteriaInformation) {
		return new ExportPatientSearchCriteriaInformationController(exportPatientSearchCriteriaInformation);
	}
	...
	DatawarehouseUpdatedEventHandler datawarehouseUpdatedEventController(
			ExportPatientSearchCriteriaInformationController exportPatientSearchCriteriaInformationController, ExportSubjectsController exportSubjectsController) {
		return new DatawarehouseUpdatedEventHandler(exportPatientSearchCriteriaInformationController, exportSubjectsController);
	}
