...
public class DatawarehouseUpdatedEventHandler implements EHR2EDCAsyncEventController<DatawarehouseUpdatedEvent> {
	...
	public DatawarehouseUpdatedEventHandler(
			ExportPatientSearchCriteriaInformationController exportPatientSearchCriteriaInformationController,
			ExportSubjectsController exportSubjectsController) {
		handlers.add(exportPatientSearchCriteriaInformationController::handle);
