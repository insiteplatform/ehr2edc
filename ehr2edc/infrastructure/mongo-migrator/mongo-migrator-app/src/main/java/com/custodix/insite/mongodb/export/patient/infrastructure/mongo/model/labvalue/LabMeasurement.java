...
public final class LabMeasurement {
	...
	private LabMeasurement(BigDecimal lowerLimit, BigDecimal upperLimit, BigDecimal value, String unit) {
	...
	private LabMeasurement(Builder builder) {
	...
	public static Builder newBuilder(LabMeasurement copy) {
	...
	public static final class Builder {
		...
		public LabMeasurement build() {
			return new LabMeasurement(this);
		}
	}
}
