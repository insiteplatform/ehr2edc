...
public final class ExportPatientFailed {
	...
	private ExportPatientFailed(final Builder builder) {
	...
	public static final class Builder {
		...
		public ExportPatientFailed build() {
			return new ExportPatientFailed(this);
		}
