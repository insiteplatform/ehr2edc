...
public class ReviewedProvenanceMedicationDocumentObjectMother {
	...
	public static ReviewedProvenanceMedicationDocument omeprazole() {
		return omeprazoleBuilder().build();
	}

	public static ReviewedProvenanceMedicationDocument.Builder omeprazoleBuilder() {
		return ReviewedProvenanceMedicationDocument.newBuilder()
				.withConcept(ReviewedMedicationConceptDocument.newBuilder()
						.withConcept(ReviewedConceptCodeDocument.of(OMEPRAZOLE_CODE))
						.withName(OMEPRAZOLE_NAME)
						.build())
				.withStartDate(OMEPRAZOLE_START_DATE)
				.withEndDate(OMEPRAZOLE_END_DATE)
				.withDosage(ReviewedDosageDocument.newBuilder()
