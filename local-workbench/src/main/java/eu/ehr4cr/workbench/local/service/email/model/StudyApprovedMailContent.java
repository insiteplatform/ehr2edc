...
public final class StudyApprovedMailContent implements MailContent {
	...
	private StudyApprovedMailContent(Builder builder) {
	...
	public Mail createMail(String senderAddress, List<String> recipientAddresses) {
		return new StudyApprovedMail(senderAddress, recipientAddresses, this);
	}
	...
	public boolean equals(Object o) {
		...
		StudyApprovedMailContent that = (StudyApprovedMailContent) o;
	...
	public static final class Builder {
		...
		public StudyApprovedMailContent build() {
			return new StudyApprovedMailContent(this);
		}
	}
}
